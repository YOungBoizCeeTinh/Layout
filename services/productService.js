...
export const updateProduct = async (productId, updatedData) => {
    try {
        ...
        const errorMessage = error.response?.message || `Không thể cập nhật sản phẩm có ID: ${productId}`;
        throw new Error(errorMessage);
    }
};
...
export const getAllProducts = async () => {
    try {
        ...
        const errorMessage = error.response?.message || 'Không thể lấy danh sách sản phẩm.';
        throw new Error(errorMessage);
    }
};
